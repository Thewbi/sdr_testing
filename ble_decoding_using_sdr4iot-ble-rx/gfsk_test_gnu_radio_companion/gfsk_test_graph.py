...
class gfsk_test_graph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_uchar_to_float_0, 0))
        ...
        self.connect((self.digital_gfsk_demod_0, 0), (self.blocks_uchar_to_float_1, 0))
